---
layout: post
title: "Daily Inspiration on Every New Tab: Bible, Quran & Motivational Quotes"
description: "Transform your Safari new tab page with daily inspiration. Get Bible verses, Quran passages, or motivational quotes every time you open a new tab on iPhone and Mac."
date: 2026-03-13
...
[Bible Tab](/apps/bible-tab/) replaces Safari's new tab page with a verse from the Bible, displayed on a clean, visually calming background. Each tab opening presents a different verse, creating a passive but consistent engagement with scripture throughout your day.
...
[Quran Tab](/apps/quran-tab/) brings verses from the Quran to your Safari new tab page, presenting both the original Arabic text and a translation with each tab opening.
...
[Motivation Quotes & Affirmations](/apps/motivation-quotes/) takes a non-religious approach to new tab inspiration, drawing from a diverse collection of thinkers, leaders, scientists, writers, and philosophers across centuries and cultures.
...
**Pair with complementary tools.** Use [Sticky Notes for Safari](/apps/sticky-notes/) to capture thoughts triggered by a new tab verse directly on the pages you visit afterward. This creates a thread of inspired thought woven through your browsing. See our [productivity extensions guide](/blog/safari-extensions/best-note-taking-and-productivity-safari-extensions/) for more on this.

## Complementary Extensions for a Mindful Browsing Experience

- **[Make It Dark Mode](/apps/make-it-dark-mode/)** reduces visual harshness across all websites, creating a calmer browsing environment that complements the reflective tone of inspirational new tabs. See our [dark mode guide](/blog/safari-extensions/how-to-enable-dark-mode-on-every-website-in-safari/).
- **[Auto-Scroll](/apps/auto-scroll/)** enables hands-free reading for longer spiritual or motivational texts. Covered in our [auto-scroll guide](/blog/safari-extensions/how-to-auto-scroll-and-auto-refresh-pages-in-safari/).
- **[Save as PDF](/apps/save-as-pdf/)** preserves articles and resources that your new tab verse leads you to explore. See the [PDF saving guide](/blog/safari-extensions/how-to-save-any-web-page-as-a-pdf-in-safari/).
