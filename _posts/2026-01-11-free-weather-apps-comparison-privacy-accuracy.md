...
related_apps: [local-weather-yawa, crr, redirect-map-for-safari]
---
...
Weather is not the only category where location is the real product. Maps are the other obvious one, and the two dominant map services differ far more in what they retain than in what they show you -- [what Apple Maps and Google Maps each collect](/blog/safari-extensions/apple-maps-vs-google-maps-privacy-data-collection/) applies the same reading to that category, including the part most people overlook: opening a map in a browser tab is a different exposure from opening it in an app.
